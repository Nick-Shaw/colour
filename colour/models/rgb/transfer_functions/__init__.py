...
LOG_ENCODINGS : CaseInsensitiveMapping
    **{'ACEScc', 'ACEScct', 'ACESproxy', 'ALEXA Log C', 'Blackmagic Film',
    ...
    'Log3G12', 'Panalog', 'PLog', 'Protune', 'REDLog', 'REDLogFilm', 'S-Log',
    'S-Log2', 'S-Log3', 'T-Log', 'V-Log', 'ViperLog'}**
"""
...
def log_encoding(value, function='Cineon', **kwargs):
    ...
    function : unicode, optional
        **{'ACEScc', 'ACEScct', 'ACESproxy', 'ALEXA Log C', 'Blackmagic Film',
        ...
        'Blackmagic Pocket 4K Film', 'Blackmagic Pocket 6K Film',
        'Canon Log 2', 'Canon Log 3', 'Canon Log', 'Cineon', 'D-Log',
        'ERIMM RGB', 'F-Log', 'Filmic Pro 6', 'Log3G10', 'Log3G12', 'Panalog',
